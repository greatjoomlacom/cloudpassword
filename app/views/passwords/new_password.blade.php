<div class="passwords">
    {{ Form::open(array('action' => 'PasswordsController@postNewPasswordSave')) }}
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-lg-6">
                ...
                {{ Form::text('title', '', array('class' => 'form-control focus-first', 'placeholder' => Lang::get('passwords.form.placeholder.title'))) }}
            </div>
        </div>
        <div class="row">
            <div class="form-group col-lg-6">
                {{ Form::label('username', Lang::get('passwords.form.label.username') . ' ' . Lang::get('shared.form.required_mark')) }}
                {{ Form::text('username', '', array('class' => 'form-control', 'placeholder' => Lang::get('passwords.form.placeholder.username'))) }}
            </div>
        </div>
        <div class="row">
            <div class="form-group col-lg-6">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        {{ Form::text('password', $random, array('class' => 'form-control', 'placeholder' => Lang::get('passwords.form.placeholder.password'))) }}
                    </div>
                </div>
                <div class="row">
        ...
        <div class="row">
            <div class="form-group col-lg-6">
                ...
                {{ Form::text('url', '', array('class' => 'form-control', 'placeholder' => Lang::get('passwords.form.placeholder.url'))) }}
            </div>
        </div>
        <div class="row">
            <div class="form-group col-lg-6">
                {{ Form::label('note', Lang::get('passwords.form.label.note')) }}
                {{ Form::textarea('note', '', array('class' => 'form-control', 'placeholder' => Lang::get('passwords.form.placeholder.note'))) }}
            </div>
        </div>
        <div class="row col-lg-12">
            {{ Typography::form_button('submit', Lang::get('passwords.form.button.save'), 'btn-default', 'icon-ok-sign') }}
