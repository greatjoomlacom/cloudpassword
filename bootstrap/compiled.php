...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return 'D:\\XAMPP\\data\\htdocs\\cloudpassword.local\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
...
class ExceptionServiceProvider extends ServiceProvider
{
    ...
    {
        return 'D:\\XAMPP\\data\\htdocs\\cloudpassword.local\\vendor\\laravel\\framework\\src\\Illuminate\\Exception' . '/resources';
    }
}
    ...
    public function handle($level, $message, $file = 'unknown', $line = 0, $context = array())
    {
        ...
        if ($this->displayErrors && error_reporting() & $level && $this->level & $level) {
            if (!class_exists('Symfony\\Component\\Debug\\Exception\\ContextErrorException')) {
                require 'D:\\XAMPP\\data\\htdocs\\cloudpassword.local\\vendor\\symfony\\debug\\Symfony\\Component\\Debug' . '/Exception/ContextErrorException.php';
            }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = 'D:\\XAMPP\\data\\htdocs\\cloudpassword.local\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
        }
